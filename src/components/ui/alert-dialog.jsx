...
const AlertDialogOverlay = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      // z-[70]: must render above app sheets that use z-[60] (e.g. SettingsSheet),
      // so this dialog's own buttons receive clicks instead of the sheet's backdrop
      // underneath it swallowing them. Stays below toast (z-[100]).
